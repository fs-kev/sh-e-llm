...
def pedir_al_llm(prompt: str, system_prompt: str) -> str:
    ...
    for proveedor in PROVEEDORES_EN_ORDEN:
        ...
        if not api_key:
            print(f"[yellow]Advertencia: No se encontró clave de API para {nombre_proveedor}. Saltando...[/yellow]")
            continue
...
if __name__ == "__main__":
    ...
    system_prompt = "Eres un experto en Python y debes responder de manera clara y concisa."
